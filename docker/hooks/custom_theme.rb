...
#
# Registers an OpenProject/Redmine hook listener that injects the custom dark
# theme stylesheet and font CSS into every page's <head> via the
...
Redmine::Hook.add_listener(OpenProjectCustomTheme::HookListener)
